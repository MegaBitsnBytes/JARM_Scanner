...
* Python 3.x
* A valid [Shodan API Key](https://account.shodan.io/) (Free or Paid)
...
3. **Add your API Key:**
   Open the Python script (`jarm_hunter.py`) in your preferred text editor and replace the placeholder variable with your actual Shodan API key:
   ```python
